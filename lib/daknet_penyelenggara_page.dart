...
class DakNetPenyelenggaraPage extends StatefulWidget {
  const DakNetPenyelenggaraPage({Key? key}) : super(key: key);

  @override
  _DakNetPenyelenggaraPageState createState() =>
      _DakNetPenyelenggaraPageState();
}

class _DakNetPenyelenggaraPageState extends State<DakNetPenyelenggaraPage> {
  ...
  void initState() {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse("http://10.0.2.2/user/login"));
    initFilePicker();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            const Text('DakNet Penyelenggara', style: TextStyle(color: Colors.white)),
